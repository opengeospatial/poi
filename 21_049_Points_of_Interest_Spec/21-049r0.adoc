...
:fullname: Matthew Brian John Purss
:fullname_2: Editor Two
:docsubtype: Interface
:keywords: ogcdoc, OGC document, poi, points of interest
:submitting-organizations: Organization One; Organization Two
:docfile: 21-049r0.adoc
:mn-document-class: ogc
:mn-output-extensions: xml,html,doc,pdf
:local-cache-only:
:data-uri-image:
:pdf-uri: ./21-049r0.pdf
:xml-uri: ./21-049r0.xml
:doc-uri: ./21-049r0.doc
:edition: 1.0
