...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/poi/1.0
|Internal reference number of this OGC(R) document:    21-049
|Version: 0.1
|Category: OGC(R) Implementation Standard
|Editor:   Matthew Brian John Purss
|===
