...
The draft OGC Point of Interest (POI) Part 2: JSON Encoding Standard defines how the POI Conceptual model should be implemented in JSON. Development of this Standard is taking place in the 23-045 directory. The current draft is available in https://htmlpreview.github.io/?https://github.com/opengeospatial/poi/blob/main/23-045/23-045.html[HTML], https://github.com/opengeospatial/poi/blob/main/23-045/23-045.pdf[PDF], and https://github.com/opengeospatial/poi/blob/main/23-045/23-045.doc[Word] formats.
