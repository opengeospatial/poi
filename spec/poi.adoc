...
image:model.png[UML model of the POI core data model]
...
image:core-spatialoperators-20111216.jpg[Diagram of the 8 allowed term attributes of the relationship element]
