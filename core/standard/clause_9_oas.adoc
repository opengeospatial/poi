...
CAUTION: Related to link:https://github.com/opengeospatial/POI/issues/90[ISSUE 90] +
...
CAUTION: link:https://github.com/opengeospatial/POI/issues/46[ISSUE 46] +
...
CAUTION: link:https://github.com/opengeospatial/POI/issues/45[ISSUE 45] +
...
content:
  application/json:
    schema:
      $ref: https://raw.githubusercontent.com/opengeospatial/POI/master/core/openapi/schemas/exception.yaml
  text/html:
    schema:
      type: string
----
...
CAUTION: link:https://github.com/opengeospatial/POI/issues/41[ISSUE 41] +
