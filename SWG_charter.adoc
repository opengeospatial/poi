...
2.	Add a JSON encoding with particular attention paid to support ways to build resilient and scalable PoI architectures including but not limited to DGGS and OGC APIs
4.	Provide an abstract and/or conformance  test suite.
5.	Validate all schemas and examples.
6.	Prepare and publish a user guide in compliance with OGC policies.
7.	Study the interactions between service model and data encoding approaches to POI and gazetteer functions.
8.	Address any other technical and/or editorial issues that arise during the review period.
...
•	Points of Interest (POI) Information Model and JSON Encoding Specification version 1.0.
