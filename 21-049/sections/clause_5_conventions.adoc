...
The POI Conceptual Model (CM) Standard is defined in a <<omguml,Unified Modeling Language>> (UML) model. It is presented in this document through diagrams using the UML static structure diagram. The UML notations used in this standard are described in the diagram in <<figure-1>>.
...
Compositions are a form of association where the Component Class is treated as an attribute of the Composit Class. Component Classes are an integral part of the Composit Class and cannot be sharred by multiple Composit Classes. No Compositions are used in this Standard.  
