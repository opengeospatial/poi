...
The OGC Feature Model is defined in <<ISO19109>>. A UML model showing applicable portions of the OGC Feature Model is provided in <<feature_model,Figure 3>>. 
...
The OGC Geometry model is defined in <<ISO19107>>. While there is a new version of this standard, it has not been widely implemented. Therefore, the 2003 version has been used in this Standard.
