...
In addition, ISO Technical Committee 211 provides a harmonized UML model which encompasses all of the ISO Standards used by this POI Conceputal Model. That UML model is available from the ISO TC211 <<Harmonized Model Maintenance Group,HMMG>>.
