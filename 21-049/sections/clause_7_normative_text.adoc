...
The POI Standard builds on a base of ISO Standards maintained by ISO Technical Committee 211 (TC211). These Standards are widely implemented in both proprietary and open source software. Reuse of this software can greatly simplify the development of POI software and systems.   
