...
!{set:cellbgcolor:#FFFFFF} description «property»  !<<CharacterString-section,CharacterString>>  [0..*] !Provides further information on the feature.
...
!{set:cellbgcolor:#FFFFFF} identifer «property»  !<<ScopedName-section,ScopedName>>  [0..*] !Specifies the unique identifier of the feature that is valid globally.
